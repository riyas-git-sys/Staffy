...
export default function LoginPage() {
  return (
    <div className="w-100 h-100 flex items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-100 h-100 border border-gray-200">
