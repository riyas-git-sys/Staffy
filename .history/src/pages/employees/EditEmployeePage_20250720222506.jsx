...
export default function EditEmployeePage() {
  ...
  // In the handleSubmit function of EditEmployeePage.jsx
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateDoc(docRef, {
        ...
        role: formData.role,
        department: formData.department, // Ensure this matches your Firestore field
      ...
      navigate('/employees', { state: { refresh: true } }); // Add refresh trigger
    } catch (error) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              >
                ...
                <option value="IT_RD">Information Technology (IT) / R&D</option>
                <option value="Sales">Sales & Business Development</option>
                <option value="Engineering_RD">Engineering / R&D</option>
