...
export default function EditEmployeePage() {
  // Mock data for demonstration - replace with actual router params and Firebase
  ...
  useEffect(() => {
    const fetchEmployee = async () => {
      try {
        ...
        const nameParts = mockData.fullName?.split(' ') || [];
        setFormData({
          ...
          department: mockData.department || 'Information Technology(IT)',
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      const mockImageUrl = `https://via.placeholder.com/150?text=${file.name}`;
      setFormData(prev => ({ ...prev, profileImage: mockImageUrl }));
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Mock Firebase update - replace with actual Firebase call
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Update employee information and profile details</p>
              </div>
            </div>
            <button
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20">
          <div onSubmit={handleSubmit} className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              {/* Salary */}
              <div className="group">
                <label className="block text-sm font-semibold text-gray-700 mb-2">Annual Salary (USD)</label>
