...
export default function EmployeeDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      {/* Company Header Card */}
      <div className="max-w-4xl flex flex-col items-center justify-between mx-auto mb-6 p-6 rounded-xl shadow-md bg-gradient-to-r from-red-500 via-yellow-400 to-purple-500">
        {/* Top Section */}
