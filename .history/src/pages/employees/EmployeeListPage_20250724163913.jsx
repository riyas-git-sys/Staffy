...
export default function EmployeeListPage() {
  ...
  const filteredEmployees = employees.filter(emp => {
    ...
    // Apply other filters
    const departmentMatch = !filters.department || (emp.department && emp.department === filters.department);
    const roleMatch = !filters.role || (emp.role && emp.role === filters.role);
    const statusMatch = !filters.status || (emp.status && emp.status === filters.status);
