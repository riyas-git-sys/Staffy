      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setEmployee({
            id: docSnap.id,
            ...data,
            // Initialize links if they exist
            links: data.links || {
              linkedIn: '',
              github: '',
              website: ''
      ...
      <div className="w-xl max-w-xl flex flex-col items-center justify-between mx-auto mb-6 p-6 rounded-xl shadow-md bg-gradient-to-r from-red-700 to-purple-700 transform transition-transform duration-300 hover:scale-[1.03]">
        ...
        <div className="w-full flex items-center mb-2 p-4 backdrop-blur-sm rounded-xl">
          ...
          <div className="text-white">
            ...
            <p className="text-sm font-mono opacity-90 mb-2">Employee ID:</p>
            <p className="text-sm font-sans opacity-90 mb-2 ml-3">   {employee.id}</p>
            <p className="text-lg font-semibold mb-2">{employee.role}</p>
            <p className="text-base font-mono opacity-90 mb-2">{employee.department}</p>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            {showLinkForm && (
              <div className="bg-gray-50 p-5 rounded-lg">
                <h3 className="text-lg font-semibold mb-3 border-b pb-2">Add Social Links</h3>
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    {links.linkedIn && !links.linkedIn.includes('linkedin.com') && (
                      <p className="text-red-500 text-xs mt-1">Please enter a valid LinkedIn URL</p>
                    )}
                  </div>
                  <div>
                    ...
                    />
                    {links.github && !links.github.includes('github.com') && (
                      <p className="text-red-500 text-xs mt-1">Please enter a valid GitHub URL</p>
                    )}
                  </div>
                  <div>
            ...
            {/* Social Links */}
            <h3 className="text-lg font-semibold mb-3 border-b pb-2">Social Links</h3>
            <div className="w-full flex justify-start space-x-8 pt-1">
              {employee.links?.linkedIn && (
                <a 
                  href={employee.links.linkedIn} 
                  target="_blank" 
              ...
              {employee.links?.github && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-black hover:text-black-500 transition-colors transform hover:scale-110"
                >
              ...
              {employee.links?.website && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-green-700 hover:text-green-600 transition-colors transform hover:scale-110"
                >
