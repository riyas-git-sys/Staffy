...
export default function EmployeeDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      {/* Company Header Card */}
      <div className="max-w-4xl flex items-center justify-between mx-auto mb-6 bg-white rounded-lg shadow-md overflow-hidden">
        <div className="bg-blue-600 p-4 text-white">
          <h1 className="text-2xl font-bold">STAFFY</h1>
          <p className="text-blue-100">Beacause People Matter</p>
        </div>
        <div className="flex flex-col items-center space-x-4">
          <h1 className='text-xl font-bold'>
            {employee.firstName} {employee.lastName}
          </h1>
          <p className="text-DarkGrey-100">{employee.id}</p>
        </div>
      </div>
