...
export default function EmployeeDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      {/* Company Header Card */}
      <div className="max-w-4xl flex flex-col items-center justify-between mx-auto mb-6 p-6 rounded-lg shadow-md bg-gradient-to-r from-red-500 via-yellow-400 to-purple-500">
        {/* Top Section */}
        ...
        {/* Middle Section */}
        <div className="w-full flex items-center mb-6 p-4 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg">
          {/* Employee Image */}
          <div className="w-32 h-32 border-4 border-white rounded-full overflow-hidden mr-6">
            <img 
          ...
          <div className="text-white">
            ...
            <p className="text-sm opacity-90">Employee ID: EMP12345</p>
            <p className="text-lg font-semibold">Senior Developer</p>
            <p className="text-sm opacity-90">Engineering Department</p>
          </div>
        </div>
        
        {/* Bottom Section */}
        <div className="w-full flex justify-center space-x-8 pt-4">
