...
export default function EmployeeDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 p-4 transition-all duration-700">
      {/* Company Header Card */}
      <div className={`max-w-5xl mx-auto mb-8 transform transition-all duration-1000 ${
        ...
        <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-gradient-to-r from-red-600 via-purple-600 to-blue-600 hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] group">
          ...
          <div className="absolute bottom-4 left-4 transform transition-all duration-500 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-2">
            <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-sm shadow-lg transition-all duration-300 ${
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-4xl font-bold text-white tracking-wider animate-fade-in-right">
                STAFFY
              </h1>
              <div className="transform transition-transform duration-300 hover:scale-110 hover:rotate-6">
                <img 
                  src="https://i.ibb.co/C7r84Tz/emplogo.png" 
                  alt="Staffy-logo" 
                ...
                <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl shadow-lg border border-gray-100">
                    ...
                    <div className="flex justify-start space-x-6 mb-6">
                      {employee.links?.linkedIn && (
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="group relative p-4 bg-blue-600 text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-2"
                        >
                      ...
                      {employee.links?.github && (
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="group relative p-4 bg-gray-800 text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-2"
                        >
                      ...
                      {employee.links?.website && (
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="group relative p-4 bg-emerald-600 text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-2"
                        >
                  ...
                  <div className="flex flex-wrap gap-4">
                    <button 
                      ...
                      className="group flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl font-semibold shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
                    >
                    ...
                    <button 
                      ...
                      className="group flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
                    >
          ...
          <div className="bg-gradient-to-r from-gray-100 to-gray-200 px-8 py-6 border-t border-gray-200">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <p className="text-gray-600 font-semibold">STAFFY Employee Management</p>
              </div>
              <p className="text-sm text-gray-500 flex items-center space-x-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span>Last updated: {employee.updatedAt ? new Date(employee.updatedAt.toDate()).toLocaleString() : 'Unknown'}</span>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Delete Button */}
      <div className={`max-w-5xl mx-auto mt-8 flex justify-end transform transition-all duration-1000 delay-400 ${
        isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
      }`}>
        <button 
          onClick={() => setShowDeleteModal(true)}
          className="group flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 border-2 border-red-500 hover:border-red-400"
        >
