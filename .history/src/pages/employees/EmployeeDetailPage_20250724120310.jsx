                    ...
                    <div className="flex justify-start space-x-6 mb-6">
                      {employee.links?.linkedIn && (
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="group relative p-2 bg-blue-600 text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-2"
                        >
