...
export default function EmployeeDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      {/* Company Header Card */}
      <div className="w-xl max-w-xl flex flex-col items-center justify-between mx-auto mb-6 p-6 rounded-xl shadow-md bg-gradient-to-r from-red-500 via-black to-purple-500 transform transition-transform duration-300 hover:scale-[1.03]">
        {/* Top Section */}
