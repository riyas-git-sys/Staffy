  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex items-center">
        ...
        <button 
          onClick={onClick}
          className="ml-auto bg-[#9E182B] hover:bg-[#7e1222] text-white px-4 py-2 rounded transition-colors flex items-center"
        >
          <Ionicons name="log-out" size={18} color="white" className="mr-2" />
          Logout
        </button>
      </div>
    </header>
