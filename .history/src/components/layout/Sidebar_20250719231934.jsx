  ...
  return (
    <div className="w-64 h-full bg-white shadow">
      ...
      <div className="p-4 border-b flex items-end">
        <button className="flex-1 text-right text-xl font-bold text-red-800 ">Close</button>
      </div>
      <nav>
        <ul className="space-y-2">
          <li><a href="/dashboard" className="block px-4 py-2 hover:bg-gray-700 rounded">Dashboard</a></li></li>
